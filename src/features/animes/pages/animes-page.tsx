        ...
        <div className="flex w-full max-w-xl flex-col gap-4 sm:flex-row sm:items-center">
          ...
          >
            <button
              ...
              className={`flex w-full items-center gap-2 rounded-xl bg-zinc-900 py-3.5 pr-4 pl-4 text-left text-sm ring-1 transition-all ${
                isGenreOpen
                  ? "bg-zinc-800/80 text-white ring-blue-500/50"
                  : genreId
                    ? "text-white ring-blue-500/30"
                    : "text-zinc-400 ring-zinc-800 hover:bg-zinc-800/50 hover:text-zinc-200"
              }`}
            >
            ...
            {/* Dropdown Panel */}
            {isGenreOpen && (
              <div className="absolute top-full left-0 z-50 mt-2 w-64 overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/95 shadow-2xl shadow-black/50 backdrop-blur-xl">
                {/* Busca interna */}

...
export function AnimeCard({ anime }: AnimeCardProps) {
  ...
  return (
    <div className="group relative aspect-2/3 w-full min-w-[140px] cursor-pointer overflow-hidden rounded-xl bg-zinc-900 transition-all duration-500 hover:scale-105 hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] sm:min-w-[200px]">
      {/* Poster */}
      <img
      ...
      {/* Hover Overlay */}
      <div className="absolute inset-0 flex flex-col justify-end bg-linear-to-t from-black via-black/20 to-transparent p-3 opacity-0 transition-opacity duration-500 group-hover:opacity-100 sm:p-5">
        <div className="translate-y-4 transition-all duration-500 ease-out group-hover:translate-y-0">
          ...
          <h3 className="group-hover:text-primary mt-1 line-clamp-2 text-sm leading-tight font-black text-white transition-colors sm:mt-2 sm:text-base">
            {anime.title}
          </h3>

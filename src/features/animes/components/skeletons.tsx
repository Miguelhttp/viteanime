...
export function CarouselSkeleton() {
  return (
    <section className="group relative w-full overflow-hidden rounded-2xl bg-zinc-100 shadow-2xl dark:bg-zinc-950">
      <Skeleton className="h-[380px] w-full rounded-none sm:h-[500px] lg:h-[650px]">
        <div className="absolute inset-0 bg-linear-to-r from-zinc-100 via-zinc-100/50 to-transparent dark:from-zinc-950/90 dark:via-zinc-950/50" />
  ...
  return (
    <div className="min-h-screen bg-white pb-20 dark:bg-black">
      ...
      <div className="mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-12 px-4 sm:px-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 border-r border-zinc-200 pr-4 lg:col-span-1 dark:border-white/5">

              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-zinc-950/50 py-3.5 pr-4 pl-12 text-white placeholder-zinc-500 ring-1 ring-white/10 transition-all focus:bg-zinc-950 focus:ring-blue-500 focus:outline-none"
                  />
                </div>
              </div>

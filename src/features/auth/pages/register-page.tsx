              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Miguel"
                    className="w-full rounded-xl bg-slate-950/50 py-3.5 pr-4 pl-12 text-white placeholder-slate-500 ring-1 ring-white/10 transition-all focus:bg-slate-950 focus:ring-fuchsia-500 focus:outline-none"
                  />
                </div>
              </div>

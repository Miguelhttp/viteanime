  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-16 px-4 pt-32 pb-20 sm:px-6">
      ...
      <section className="space-y-6 text-center">
        <h1 className="bg-linear-to-r from-white via-white to-slate-400 bg-clip-text text-4xl font-black tracking-tighter text-transparent sm:text-6xl lg:text-7xl">
          VITEANIME
        </h1>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="group rounded-2xl bg-slate-900/50 p-8 shadow-sm ring-1 ring-slate-800 transition-all hover:bg-slate-800/50 hover:ring-blue-500/30">
        ...
        <div className="group rounded-2xl bg-slate-900/50 p-8 shadow-sm ring-1 ring-slate-800 transition-all hover:bg-slate-800/50 hover:ring-purple-500/30">
        ...
        <div className="group rounded-2xl bg-slate-900/50 p-8 shadow-sm ring-1 ring-slate-800 transition-all hover:bg-slate-800/50 hover:ring-green-500/30">
      ...
      {/* Content Section */}
      <section className="rounded-3xl bg-linear-to-b from-slate-900/50 to-transparent p-8 shadow-sm ring-1 ring-slate-800 sm:p-12">
        <div className="max-w-3xl space-y-8">
          ...
          <div className="flex flex-wrap gap-6">
            <a
              ...
              className="flex items-center gap-2 font-bold text-slate-100 transition-colors hover:text-white"
            >
